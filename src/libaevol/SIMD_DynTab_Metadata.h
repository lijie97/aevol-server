...
#ifndef AEVOL_SIMD_DYNTAB_METADATA_H
#define AEVOL_SIMD_DYNTAB_METADATA_H
...
*/
        ...
        void update_positions(int pos_after, int pos_before,int8_t add_or_reduce,  int length_diff, int8_t mark) {assert(true); exit(-1);}
