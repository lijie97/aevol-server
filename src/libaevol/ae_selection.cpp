  ...
  if ( _alea->random() < _HT_ins_rate )
  {
    ...
    if ( alignment_1 != NULL )
    {
      ...
      if ( alignment_2 != NULL )
      {
        ...
        if ( genome_length_after > _exp_m->get_max_genome_length() )
        {
          #warning LOG
  ...
  if ( _alea->random() < _HT_repl_rate )
  {
    ...
    if ( alignment_1 != NULL )
    {
      ...
      if ( alignment_2 != NULL )
      {
        ...
        if ( genome_length_after < _exp_m->get_min_genome_length() || genome_length_after > _exp_m->get_max_genome_length() )
        {
          #warning LOG
