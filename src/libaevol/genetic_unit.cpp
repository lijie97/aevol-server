...
/*!
  ...
  will be performed.
*/
GeneticUnit::GeneticUnit( ae_individual* indiv, int32_t length, ae_jumping_mt * prng )
{
  _indiv = indiv;
...
*/
void GeneticUnit::compute_distance_to_target( Environment* env )
{
...
*/
void GeneticUnit::compute_fitness( Environment* env )
{
